...
export default function ProjectGallery({ images }: Props) {
  ...
  return (
    <section className="px-4 md:px-10 py-10 md:py-14">
      <h2 className="text-xl md:text-2xl font-bold text-white text-center md:text-right max-w-6xl mx-auto mb-8">
        {t("title")}
      </h2>
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="hidden md:flex absolute top-[140px] left-1/2 -translate-x-1/2 items-center bg-background/90 backdrop-blur-sm rounded-full overflow-hidden z-20 shadow-lg">
          <button
            onClick={scrollPrev}
            aria-label="prev"
            className="flex items-center justify-center w-12 h-12 text-white hover:bg-white/10"
          >
            <ArrowLeft size={18} />
          </button>
      ...
      <p className="text-center text-sm text-white/40 max-w-md mx-auto mt-6 leading-relaxed">
        {t("subtitle")}
      </p>
    </section>
  );
